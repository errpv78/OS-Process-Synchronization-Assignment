...
void producer(int pid)
{
    ...
    while(1)
    {
        ...
        if(choice==1)
        {
            ...
            file_w.close();
            sem_post(&s_file);
            cout<<"File released by producer: "<<pid<<endl;
    ...
    while(1)
    {
        ...
        if(p*10>choice)
        {
            ...
            if(queue_choice == 1)
            {
                ...
                file_w.close();
                sem_post(&s_file);
                cout<<"File released by consumer: "<<pid<<endl;
...
int main()
{
  ...
  std::thread t6(consumer, 1,0.2);
  std::thread t7(consumer, 2,0.2);
  std::thread t8(consumer, 3,0.2);
  std::thread t9(consumer, 4,0.2);
  std::thread t10(consumer, 5,0.2);
        ...
        if(s[i]=='2' && s[i+10]=='1')
        {
            ...
            for(int j=15;j<20;j++)
            {
                if(s[j]=='2' && s[j-10]=='1')
                {
                    ...
                    cout<<"\nNumber of inserts: "<<num_of_inserts;
                    cout<<"\nNumber of removes: "<<num_of_removes;
                    exit(0);
